...
print(mes)
lcd1771.disp(mes,12,'white')
mes= '12345678901234567890'
lcd1771.disp(mes,16,'blue')
mes= '1234567890123456'
lcd1771.disp(mes,20,'red')
mes= '1234567890123'
lcd1771.disp(mes,24,'green')
mes= '12345678901'
lcd1771.disp(mes,28,'white')
mes= '12345678901'
lcd1771.disp(mes,32,'blue')
time.sleep(0.5)
lcd1771.init('reset')
